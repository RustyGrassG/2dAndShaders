...
#Animate a triangle going accross the screen
class Test(Base):
    ...
    def update(self):
        ...
        #increase x cordinate of the translation
        self.translation.data[0] += 0.01
        #if triangle passes offscreen to the right, change translation so it reappears on the left
